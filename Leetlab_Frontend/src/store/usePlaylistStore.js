...
export const usePlaylistStore = create((set, get) => ({
  ...
  createPlaylist: async (playlistData) => {
    try {
      ...
      set((state) => ({
        playlists: [...state.playlists, response.data.playlist],//playlist
      }));

      toast.success("Playlist created successfully");
      return response.data.playlist;//playList
    } catch (error) {
  ...
  getAllPlaylists: async () => {
    try {
      ...
      set({ playlists: response.data.playlists });//playList 
    } catch (error) {
  ...
  getPlaylistDetails: async (playlistId) => {
    try {
      ...
      set({ currentPlaylist: response.data.playlist });//playList
    } catch (error) {
